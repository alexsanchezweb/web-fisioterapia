  ...
  return (
    ...
    >
      <div className="relative">
        {/* Subtle pulse */}
        <div className="absolute inset-0 rounded-full bg-[#25D366] animate-ping opacity-15" />

        {/* Button */}
        <div className="relative w-13 h-13 w-14 h-14 rounded-full bg-[#25D366] flex items-center justify-center shadow-lg hover:shadow-xl hover:scale-105 transition-all duration-200">
